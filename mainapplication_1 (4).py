...
def gettechnical_indicators(ticker):
    ...
    summary = {
        ...
        'Close > EMA 50?': close_gt_ema50,
        'EMA 50 > EMA 100?': ema50_gt_ema100,
        'RSI Status': rsi_status,
        'MACD Signal': macd_signal_result,
        'Close - BB Upper': round(bb_upper_diff, 2),
        'Close - BB Middle': round(bb_middle_diff, 2),
        'Close - BB Lower': round(bb_lower_diff, 2)
    }
    return summary
...
if st.button("Run Analysis"):
    if stock_name and ticker:
        ...
        try:
            tech_summary = gettechnical_indicators(ticker)
