...
!pip install vaderSentiment google-news-api pandas
...
def get_custom_technical_indicators(ticker):
    df = yf.download(ticker, period='1y', interval='1d')
    df.dropna(inplace=True)
...
if st.button("Run Analysis"):
    if stock_name and ticker:
        ...
        tech_summary.update(get_custom_technical_indicators(ticker))
        st.write(pd.DataFrame([tech_summary]))
    else:
